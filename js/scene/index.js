...
import Swipe from '../phaser_swipe.js'
...
game.States.start = function () {
  this.create = function () {
    ...
    mainAreaBackGraphics.drawRoundedRect(0, 0, game.width - 20, game.width - 20, 0);
  ...
  this.transX = function (x) {
    return 20 + 8 * (x + 1) + x * (game.width - 80)/4 + (game.width - 80)/4 / 2;
  };
  this.transY = function (y) {
    return 80 + 8 * (y + 1) + y * (game.width - 80)/4 + (game.width - 80)/4 / 2;
  };
  // 随机产生一个方块
  ...
  this.placeSquare = function (x, y, value) {
    ...
    var squareBackground = game.add.graphics(-(game.width - 80)/4 / 2, -(game.width - 80)/4 / 2);
    squareBackground.beginFill(this.colors[value]);
    squareBackground.drawRoundedRect(0, 0, (game.width - 80)/4, (game.width - 80)/4, 5);
    squareBackground.endFill();
    square.addChild(squareBackground);
    var squareText = game.add.text(-(game.width - 80)/4 / 2, -(game.width - 80)/4 / 2, value, squareStyle);
    squareText.setTextBounds(0, 0, (game.width - 80)/4, (game.width - 80)/4);
